...
class CastMediaMedialInformation {
  ...
  factory CastMediaMedialInformation.fromMap(Map<String, dynamic> map) {
    return CastMediaMedialInformation(
  ...
  factory CastMediaMedialInformation.fromJson(String source) =>
      CastMediaMedialInformation.fromMap(json.decode(source));
}
