...
//information reported by the receiver.
  ...
  factory CastBrakeStatus.fromMap(Map<String, dynamic> map) {
    return CastBrakeStatus(
  ...
  factory CastBrakeStatus.fromJson(String source) =>
      CastBrakeStatus.fromMap(json.decode(source));
}
